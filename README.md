...
Per collegarsi alla simulazione occorre cliccare sul link del web server del PLC Siemens (al solito tutte le celle in realtà sono valorizzate dalle misure in tempo reale degli ESP32).
