...
Attualmente esistono diversi servizi di monitoraggio. Tanto per citarne uno tra i piu' rappresentativi si ricorda il servizio offerto da [e-Distribuzione](https://www.e-distribuzione.it/servizi/contatore/le-mie-letture.html). Attraverso l'iscrizione nell'area riservata ed inserendo il POD del proprio contatore è possibile accedere tra le varie opzioni anche alle curve di carico dei consumi. Vedremo come sfruttare al meglio queste preziose informazioni. Tuttavia si tratta sempre di servizi di monitoraggio che non interagiscono piu' di tanto sull'impianto. Vedremo invece come sia possibile attraverso l'impiego di un PLC Siemens gestire al meglio i consumi anche attraverso la scelta ottima di prelievo da sistemi di accumulo al litio piuttosto che batterie al sale.
