...
Attualmente esistono diversi servizi di monitoraggio. Tanto per citarne uno si ricorda il servizio offerto da [e-Distribuzione](https://www.e-distribuzione.it/servizi/contatore/le-mie-letture.html) con relativa [App per smartphone](https://play.google.com/store/apps/details?id=com.enel.mobile.edistribuzione&hl=it&gl=US). Vedremo in seguito come sfruttare al meglio queste preziose informazioni. Tuttavia si tratta sempre di servizi di monitoraggio che, anche quando attivabili, non interagiscono piu' di tanto con l'impianto. Vedremo invece come sia possibile attraverso l'impiego di un PLC Siemens gestire al meglio i consumi nonchè eventuali sistemi di accumulo che utilizzano tecnologie al litio piuttosto che al sale.
