...
Si ricorda tuttavia che il sistema di monitoraggio è pensato sia per carichi **elettrici** sia per **termici** ed inoltre l'ambito di applicazione dell'algoritmo presentato di seguito va oltre le comunità energetiche rivolgendosi anche a tutte quelle realtà operative in ambito terrestre e navale.
