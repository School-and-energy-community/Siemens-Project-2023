...
Vedremo anche l'importanza delle combinazioni di orario per evitare picchi di consumo. Si pensi ad esmpio alla sovrapposizione simultanea di piu' laboratori energivori tipo saldatura, misure elettriche con prove su macchine elettriche, grandi aule di informatica, compressori di aule di pneumatica ecc.

In altre parole è possibile individuare porzioni di impianto da attivare con autorizzazione utilizzando semplicemente un account personale. L'attivazione è naturalmente un'azione libera dell'utente che in quel preciso momento è a conoscenza dell'energia è prodotta e consumata della comunità energetica.   
