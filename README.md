...
Attualmente in commercio esistono diversi servizi di monitoraggio. Ne citiamo qui uno gratuito offerto da [e-Distribuzione](https://www.e-distribuzione.it/servizi/contatore/le-mie-letture.html) con relativa [App per smartphone](https://play.google.com/store/apps/details?id=com.enel.mobile.edistribuzione&hl=it&gl=US). Cercheremo in seguito come sfruttare al meglio questi dati aggregati nei casi in cui risultano disponibili all'utente. Tuttavia si tratta sempre di servizi di monitoraggio che, anche quando attivabili, non interagiscono piu' di tanto con l'impianto. Vedremo invece come sia possibile attraverso l'impiego di un PLC Siemens gestire al meglio i consumi nonchè eventuali sistemi di accumulo che utilizzano tecnologie al litio piuttosto che al sale.
