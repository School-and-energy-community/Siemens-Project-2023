...
Di seguito si riporta un esempio con cinque utenze. Per avere risultati credibili si raccomanda il lettore di modificare i valori delle celle secondo un criterio che abbia senso fisico. I valori modificabili sono quelli in campo verde. Al solito per collegarsi al foglio occorre cliccare [QUI](https://docs.google.com/spreadsheets/d/1d6YPMBq-Hoz_CvIhF2GD6S9_o3ZyeI7vQwzNSbbCUvI/edit?usp=sharing).
